...
(function() {
    var provider = app.data.oldDataList = new Everlive({
            offlineStorage: true,
            appId: '2so1y8z6xw1b9new',
        ...
        accessTokenCacheKey = 'oldDataList_access_token',
...
// START_CUSTOM_CODE_oldDataList
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_oldDataList